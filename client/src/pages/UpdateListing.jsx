...
export default function CreateListing() {
  ...
  }, [selectedBrand, carModelsData, carModels]);
  console.log("Brand at initialization:", formData.brand);
  console.log("Model at initialization:", formData.model);
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="text-slate-100 flex items-center gap-2">
              ...
              >
                ...
                {selectedBrand &&
                  ...
                  carModelsData[selectedBrand].map((model) => (
        ...
        <div className="text-slate-100 flex flex-col flex-1 gap-4">
          <p className="font-semibold">
            Images:
            <span className="font-normal text-slate-200 ml-2 ">
